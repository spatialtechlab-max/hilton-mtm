  ...
  sections: [
    {
      ...
      items: [
        { sku: "12563", name: "Negro Black", type: "Patent Derby", cloth: "Magnanni · patent calf", price: "BHD 1,000", alt: "Patent black Derby by Magnanni", media: { kind: "photo", src: "/products/shoes/12563-negro.png" } },
        { sku: "50127", name: "Negro Whole Cut", type: "Whole-Cut Oxford", cloth: "Polished calf · black", price: "BHD 1,000", alt: "Black whole-cut Oxford", media: { kind: "photo", src: "/products/shoes/50127-negro.png" } },
        { sku: "17005", name: "Negro al Tono", type: "Patina Oxford", cloth: "Magnanni · museum finish", price: "BHD 1,000", alt: "Black museum-finish Oxford", media: { kind: "photo", src: "/products/shoes/17005-negro-al-tono.png" } },
      ],
    },
    {
      slug: "city",
      ...
      items: [
        { sku: "13232", name: "Negro Magnani", type: "Plain-Toe Oxford", cloth: "Magnanni · calf · black", price: "BHD 1,000", alt: "Plain-toe Oxford in black", media: { kind: "photo", src: "/products/shoes/13232-negro.png" } },
        { sku: "19568", name: "Conac", type: "Cognac Derby", cloth: "Magnanni · burnished calf", price: "BHD 1,000", alt: "Cognac Derby in burnished calf", media: { kind: "photo", src: "/products/shoes/19568-conac.png" } },
        { sku: "17587", name: "Conac Marron", type: "Oxford", cloth: "Magnanni · museum patina", price: "BHD 1,000", alt: "Marron museum-patina Oxford", media: { kind: "photo", src: "/products/shoes/17587-conac-marron.png" } },
        { sku: "20166", name: "Azul Magnanni", type: "Suede Oxford", cloth: "Magnanni · navy suede", price: "BHD 1,000", alt: "Navy suede Oxford by Magnanni", media: { kind: "photo", src: "/products/shoes/20166-azul.png" } },
        { sku: "5054", name: "Vintage Grafite", type: "Grafite Oxford", cloth: "Zampiere · vintage finish", price: "BHD 1,000", alt: "Graphite vintage Oxford by Zampiere", media: { kind: "photo", src: "/products/shoes/5054-grafite.png" } },
        { sku: "5396", name: "Cuoio", type: "Tan Derby", cloth: "Zampiere · cuoio calf", price: "BHD 1,000", alt: "Cuoio tan Derby by Zampiere", media: { kind: "photo", src: "/products/shoes/5396-cuoio.png" } },
      ],
    },
    {
      slug: "weekend",
      ...
      items: [
        { sku: "5308", name: "Vintage Marrone", type: "Double Monk", cloth: "Zampiere · calf & suede", price: "BHD 1,000", alt: "Double-monk in vintage marrone, calf and suede", media: { kind: "photo", src: "/products/shoes/5308-marrone.png" }, scale: 2 },
        { sku: "5227", name: "Muflone Cuoio", type: "Country Brogue", cloth: "Zampiere · muflone calf", price: "BHD 1,000", alt: "Muflone country brogue by Zampiere", media: { kind: "photo", src: "/products/shoes/5227-muflone.png" } },
        { sku: "43248-AZ", name: "Azul Combination", type: "Suede Loafer", cloth: "Navy suede & calf", price: "BHD 1,000", alt: "Navy suede and calf loafer", media: { kind: "photo", src: "/products/shoes/43248-azul.png" } },
        { sku: "43248-MA", name: "Marron Combination", type: "Suede Loafer", cloth: "Marron suede & calf", price: "BHD 1,000", alt: "Marron suede and calf loafer", media: { kind: "photo", src: "/products/shoes/43248-marron.png" } },
        { sku: "50104-AZ", name: "Azul Penny", type: "Penny Loafer", cloth: "Polished navy calf", price: "BHD 1,000", alt: "Navy penny loafer", media: { kind: "photo", src: "/products/shoes/50104-azul.png" } },
        { sku: "50104-MA", name: "Maroon Penny", type: "Penny Loafer", cloth: "Polished maroon calf", price: "BHD 1,000", alt: "Maroon penny loafer", media: { kind: "photo", src: "/products/shoes/50104-maroon.png" } },
      ],
    },
  ],
};
  ...
  sections: [
    {
      ...
      items: [
        { sku: "HBTS086", name: "Sienna Paisley", type: "8-Fold Necktie", cloth: "Como silk · paisley", price: "BHD 100", alt: "Sienna paisley tie", media: { kind: "photo", src: "/products/ties/HBTS086.webp" } },
        { sku: "HBTS085", name: "Indigo Club", type: "8-Fold Necktie", cloth: "Como silk · club stripe", price: "BHD 100", alt: "Indigo club stripe tie", media: { kind: "photo", src: "/products/ties/HBTS085.webp" } },
        { sku: "HBTS084", name: "Wine Geometric", type: "8-Fold Necktie", cloth: "Como silk · geometric", price: "BHD 100", alt: "Wine geometric tie", media: { kind: "photo", src: "/products/ties/HBTS084.webp" } },
        { sku: "HBTS083", name: "Royal Block", type: "8-Fold Necktie", cloth: "Como silk · block weave", price: "BHD 100", alt: "Royal block weave tie", media: { kind: "photo", src: "/products/ties/HBTS083.webp" } },
        { sku: "HBTS082", name: "Navy Paisley", type: "8-Fold Necktie", cloth: "Como silk · paisley", price: "BHD 100", alt: "Navy paisley tie", media: { kind: "photo", src: "/products/ties/HBTS082.webp" } },
        { sku: "HBTS081", name: "Cardinal Florals", type: "8-Fold Necktie", cloth: "Como silk · florals", price: "BHD 100", alt: "Cardinal florals tie", media: { kind: "photo", src: "/products/ties/HBTS081.webp" } },
        { sku: "HBTS080", name: "Garnet Medallion", type: "8-Fold Necktie", cloth: "Como silk · medallion", price: "BHD 100", alt: "Garnet medallion tie", media: { kind: "photo", src: "/products/ties/HBTS080.webp" } },
        { sku: "HBTS079", name: "Ink Striped", type: "8-Fold Necktie", cloth: "Como silk · diagonal", price: "BHD 100", alt: "Ink striped tie", media: { kind: "photo", src: "/products/ties/HBTS079.webp" } },
      ],
    },
    {
      slug: "library",
      ...
      items: [
        { sku: "HBTS001", name: "Cardinal Paisley", type: "8-Fold Necktie", cloth: "Como silk · paisley", price: "BHD 100", alt: "Cardinal paisley tie", media: { kind: "photo", src: "/products/ties/HBTS001.webp" } },
        { sku: "HBTS002", name: "Botanical Print", type: "8-Fold Necktie", cloth: "Como silk · print", price: "BHD 100", alt: "Botanical print tie", media: { kind: "photo", src: "/products/ties/HBTS002.webp" } },
        { sku: "HBTS003", name: "Estate Foulard", type: "8-Fold Necktie", cloth: "Como silk · foulard", price: "BHD 100", alt: "Estate foulard tie", media: { kind: "photo", src: "/products/ties/HBTS003.webp" } },
        { sku: "HBTS004", name: "Marina Stripe", type: "8-Fold Necktie", cloth: "Como silk · stripe", price: "BHD 100", alt: "Marina stripe tie", media: { kind: "photo", src: "/products/ties/HBTS004.webp" } },
        { sku: "HBTS005", name: "Crest Motif", type: "8-Fold Necktie", cloth: "Como silk · crest", price: "BHD 100", alt: "Crest motif tie", media: { kind: "photo", src: "/products/ties/HBTS005.webp" } },
        { sku: "HBTS006", name: "Garden Floral", type: "8-Fold Necktie", cloth: "Como silk · floral", price: "BHD 100", alt: "Garden floral tie", media: { kind: "photo", src: "/products/ties/HBTS006.webp" } },
        { sku: "HBTS007", name: "Salon Dot", type: "8-Fold Necktie", cloth: "Como silk · dot", price: "BHD 100", alt: "Salon dot tie", media: { kind: "photo", src: "/products/ties/HBTS007.webp" } },
        { sku: "HBTS008", name: "Trellis Weave", type: "8-Fold Necktie", cloth: "Como silk · trellis", price: "BHD 100", alt: "Trellis weave tie", media: { kind: "photo", src: "/products/ties/HBTS008.webp" } },
        { sku: "HBTS009", name: "Drawing Room", type: "8-Fold Necktie", cloth: "Como silk · pattern", price: "BHD 100", alt: "Drawing room pattern tie", media: { kind: "photo", src: "/products/ties/HBTS009.webp" } },
        { sku: "HBTS010", name: "Atelier Print", type: "8-Fold Necktie", cloth: "Como silk · print", price: "BHD 100", alt: "Atelier print tie", media: { kind: "photo", src: "/products/ties/HBTS010.webp" } },
        { sku: "HBTS011", name: "Heritage Stripe", type: "8-Fold Necktie", cloth: "Como silk · stripe", price: "BHD 100", alt: "Heritage stripe tie", media: { kind: "photo", src: "/products/ties/HBTS011.webp" } },
        { sku: "HBTS012", name: "Court Paisley", type: "8-Fold Necktie", cloth: "Como silk · paisley", price: "BHD 100", alt: "Court paisley tie", media: { kind: "photo", src: "/products/ties/HBTS012.webp" } },
        { sku: "HBTS013", name: "Library Solid", type: "8-Fold Necktie", cloth: "Como silk · solid", price: "BHD 100", alt: "Library solid tie", media: { kind: "photo", src: "/products/ties/HBTS013.webp" } },
        { sku: "HBTS014", name: "Curator Pattern", type: "8-Fold Necktie", cloth: "Como silk · pattern", price: "BHD 100", alt: "Curator pattern tie", media: { kind: "photo", src: "/products/ties/HBTS014.webp" } },
        { sku: "HBTS015", name: "Reserve Motif", type: "8-Fold Necktie", cloth: "Como silk · motif", price: "BHD 100", alt: "Reserve motif tie", media: { kind: "photo", src: "/products/ties/HBTS015.webp" } },
      ],
    },
  ],
};
  ...
  sections: [
    {
      ...
      customize: "shirt",
      items: [
        { sku: "SHT-101", name: "Mayfair White", type: "Dress Shirt", cloth: "Two-fold poplin · white", price: "From BHD 120", alt: "White poplin dress shirt", description: SHIRT_DESC, media: { kind: "photo", src: U("photo-1602810318383-e386cc2a3ccf") }, gallery: [U("photo-1602810318383-e386cc2a3ccf"), U("photo-1598033129183-c4f50c736f10"), U("photo-1620012253295-c15cc3e65df4")] },
        { sku: "SHT-102", name: "Belgrave Blue", type: "Dress Shirt", cloth: "Two-fold twill · sky", price: "From BHD 125", alt: "Sky blue twill dress shirt", description: SHIRT_DESC, media: { kind: "photo", src: U("photo-1598033129183-c4f50c736f10") }, gallery: [U("photo-1598033129183-c4f50c736f10"), U("photo-1602810318383-e386cc2a3ccf"), U("photo-1603252109303-2751441dd157")] },
        { sku: "SHT-103", name: "Eaton Stripe", type: "Dress Shirt", cloth: "Bengal stripe · blue", price: "From BHD 130", alt: "Blue bengal stripe shirt", description: SHIRT_DESC, media: { kind: "photo", src: U("photo-1620012253295-c15cc3e65df4") }, gallery: [U("photo-1620012253295-c15cc3e65df4"), U("photo-1602810318383-e386cc2a3ccf"), U("photo-1598033129183-c4f50c736f10")] },
      ],
    },
    {
      slug: "casual",
      ...
      customize: "shirt",
      items: [
        { sku: "SHT-201", name: "Harbour Oxford", type: "Casual Shirt", cloth: "Oxford cloth · white", price: "From BHD 110", alt: "White Oxford cloth shirt", description: SHIRT_DESC, media: { kind: "photo", src: U("photo-1603252109303-2751441dd157") }, gallery: [U("photo-1603252109303-2751441dd157"), U("photo-1620012253295-c15cc3e65df4"), U("photo-1598033129183-c4f50c736f10")] },
        { sku: "SHT-202", name: "Cove Chambray", type: "Casual Shirt", cloth: "Brushed chambray · indigo", price: "From BHD 115", alt: "Indigo chambray shirt", description: SHIRT_DESC, media: { kind: "photo", src: U("photo-1598033129183-c4f50c736f10") }, gallery: [U("photo-1598033129183-c4f50c736f10"), U("photo-1603252109303-2751441dd157"), U("photo-1602810318383-e386cc2a3ccf")] },
      ],
    },
  ],
};
  ...
  sections: [
    {
      ...
      customize: "trouser",
      items: [
        { sku: "TRO-101", name: "Sterling Grey", type: "Worsted Trouser", cloth: "Worsted wool · mid-grey", price: "From BHD 140", alt: "Mid-grey worsted trousers", description: TROUSER_DESC, media: { kind: "photo", src: U("photo-1624378439575-d8705ad7ae80") }, gallery: [U("photo-1624378439575-d8705ad7ae80"), U("photo-1521572163474-6864f9cf17ab"), U("photo-1473966968600-fa801b869a1a")] },
        { sku: "TRO-102", name: "Navy Flannel", type: "Flannel Trouser", cloth: "Flannel · navy", price: "From BHD 150", alt: "Navy flannel trousers", description: TROUSER_DESC, media: { kind: "photo", src: U("photo-1521572163474-6864f9cf17ab") }, gallery: [U("photo-1521572163474-6864f9cf17ab"), U("photo-1624378439575-d8705ad7ae80"), U("photo-1473966968600-fa801b869a1a")] },
      ],
    },
    {
      slug: "casual",
      ...
      customize: "trouser",
      items: [
        { sku: "TRO-201", name: "Stone Chino", type: "Cotton Chino", cloth: "Cotton twill · stone", price: "From BHD 110", alt: "Stone cotton chinos", description: TROUSER_DESC, media: { kind: "photo", src: U("photo-1473966968600-fa801b869a1a") }, gallery: [U("photo-1473966968600-fa801b869a1a"), U("photo-1624378439575-d8705ad7ae80"), U("photo-1521572163474-6864f9cf17ab")] },
        { sku: "TRO-202", name: "Olive Gabardine", type: "Cotton Trouser", cloth: "Gabardine · olive", price: "From BHD 120", alt: "Olive gabardine trousers", description: TROUSER_DESC, media: { kind: "photo", src: U("photo-1624378439575-d8705ad7ae80") }, gallery: [U("photo-1624378439575-d8705ad7ae80"), U("photo-1473966968600-fa801b869a1a"), U("photo-1521572163474-6864f9cf17ab")] },
      ],
    },
  ],
};
...
// NOTE: "chinos" used to be a hardcoded ERP-backed library here. It was a
// duplicate of the ERP-synced "chino-pants" garment (both pull CHINO PANTS),
// so it was removed — chino pants now resolve purely from the mtm_garments
// row via the dynamic /library/[slug] resolver, no hardcoding.
